...
<div class="navigationtopcontainer">
		...
		<h3 class="lefth3">LGBTQ+ Correspondent</h3><a href="/applications/lgbt/apply" class="apply">Apply for this position</a> 
...
<p class="text">The LGBTQ+ Correspondent will be responsible for assisting with news coverage of LBGTQ+-related issues, and for writing feature and opinion articles on related topics. Candidates for this position are expected to have a wide understanding of queer and trans* issues, and should have an advanced writing ability.</p>
...
<p class="text">Candidates should work very well in a team, and should expect collaboration with editors and journalists.</p>
		...
		<a href="/applications/lgbt/apply" class="applybottom">Apply for this position</a>

...
class Onboarding
{
    ...
    public static function getSignupUrl(string $serviceId, string $redirectNonce) : string
    {
        ...
        $parameters = [
            ...
            'companyAddressLine1' => WC()->countries->get_base_address(), // TODO: consider wrapping these getters with a common repository {@cwiseman 2021-05-23}
            'companyAddressLine2' => WC()->countries->get_base_address_2(),
            'companyAddressZip'   => WC()->countries->get_base_postcode(),
            'companyAddressCity'  => WC()->countries->get_base_city(),
            'companyTerritory'    => WC()->countries->get_base_state(),
            'companyWebsite'      => esc_url(home_url()),

 ...
 * @since x.y.z
 */
class GoDaddyPaymentsGateway extends AbstractPaymentGateway
{
    ...
    public $method_description = 'Accept credit/debit cards with no setup fees. Get paid fast with next-day deposits.';
    ...
    public function admin_options()
    {
        ...
        <p class="mwc-payments-godaddy-settings-description">
            <?php printf(
                ...
                '<a href="'.esc_url(add_query_arg('businessId', Poynt::getBusinessId(), StringHelper::trailingSlash(Poynt::getHubUrl()).'settings')).'" target="_blank">', ' <span class="dashicons dashicons-external"></span></a>'
            ); ?>
        </p>
    ...
    /**
     * Update the configuration values based on WooCommerce settings.
     */
    private function updateConfigurationFromSettings()
    {
        $configurations = [
            'enabled' => 'enabled',

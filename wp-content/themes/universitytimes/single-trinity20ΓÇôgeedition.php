<?php
/*
Template Name Posts: Trinity 20 General Election
*/
?>
...
<?php get_header(); ?>
			...
			<div id="content">
				...
				<div id="articlecontent">
	              ...
	              <h2 style="text-transform: uppercase; background: white; color: black; font-size: 42px; font-family: 'lft-etica', sans-serif; margin: 0px 0px 10px 0px; padding: 0px; font-weight: 800; line-height: 100%;">The Trinity Twenty: <span style="font-weight: 400;">General Election Edition</span></h2>
       ...
       <div class="utcontentgrouping">
                 ...
                 <div class="writershareblock">
                  ...
                  <span class="onebigauthorname" ><span style="margin-bottom: 5px; display:block;">By <span class="authoruppercase">Dominic McGrath</span> and <span class="authoruppercase">Sinéad Loftus</span></span></span>

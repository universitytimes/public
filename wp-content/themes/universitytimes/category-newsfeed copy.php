...
?>
		...
		<!--	<?php print_r ($ut_full_array); ?> -->
				...
				<div id="inner-content" class="wrap cf sectionpage">
				
				<h2 class="newsectionheaders sectionnews">News</h2>
...
$ids_to_query_l = array_slice( $finalpostlist, $offset, $posts_per_page_l );
    ...
    $my_query = new WP_Query( array('post_type' => array( 'post', 'feature' ), 'post__in' => $ids_to_query_l, 'posts_per_page' => $posts_per_page_l, 'orderby' => 'post__in', 'ignore_sticky_posts' => 1, 'post_status' => 'publish', 'tax_query' => array(
				array(
					'taxonomy' => 'section',
					'terms' => array('news'),
					'field' => 'slug',
...
<div id="rightofit">
						...
						<div id="leftonright">
							...
							<a href="<?php home_url(); ?>/radius" class="radiushomepagebox">
							
							<h5 class="editorialminiheading_nomargin">JUST LAUNCHED</h5>
							
							<div class="radiushomepagelogo">Radius</div>
							
							<div class="onebigcaption">The new Dublin and Trinity society, art, life and culture guide from The University Times.</div>

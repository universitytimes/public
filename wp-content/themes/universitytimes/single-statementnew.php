<?php
/*
Template Name Posts: Statement Template New
*/
?>
...
<?php get_header(); ?>
		...
		<?php if ( is_object_in_term( $post->ID, 'section', 'bobobobobobob' ) && is_object_in_term( $post->ID, 'articletype', 'editorials' ) ) : ?>
        ...
        <?php else : ?>
                  ...
                  <h2 class="articleheadline" itemprop="headline"><?php the_title(); ?></h1>
						...
						<?php		elseif ($featuredimageurl != "") : ?>
							...
							<?php endif; ?>
								...
								<div class="articlead">
									...
									<a href="mailto:business@universitytimes.ie?subject=Advertising with The University Times"><img src="http://universitytimes.ie/wp-content/themes/universitytimes/library/images/utad.jpg" /></a>

<?php
/*
Template Name Posts: QUB Video Story
*/
?>
...
<?php elseif ( is_object_in_term( $post->ID, 'section', 'radius' ) ) : ?>
				...
				<?php get_template_part( 'radiusposttemplate' );  // Radius Article Template (radiusposttemplate.php) ?>				
...
<?php else : ?>
       ...
       <div class="utcontentgrouping utcontentgroupingportrait">
...
jQuery(window).trigger('resize');
						...
						<div style="clear: both"></div>
                  						...
                  						<div class="imageadgroup portraitright">
							...
							<?php if ($utpostimage_url != '' && ($utpostimage_position == 'landscaperight' || $utpostimage_position == 'landscapeabove' || $utpostimage_position == 'portraitright') ) : ?>
								...
								<div class="articleimage articleimagevideo">
												...
												<video
    id="my-video"
    class="video-js landscapeabove"
    controls
    preload="auto"
    width="300"
    poster="http://universitytimes.ie/wp-content/themes/universitytimes/library/images/imageposter3.jpg"
    data-setup="{}"
  >
    <source src="http://universitytimes.ie/wp-content/themes/universitytimes/library/images/final2.mp4" type="video/mp4" />

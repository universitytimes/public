<?php
/*
Template Name Posts: Who's Running for Elections?
*/
?>
...
<?php get_header(); ?>
			...
			<div id="content">
				...
				<div id="articlecontentwide">
	              ...
	              <div class="infogrouping" style="margin-bottom: 15px;">
		               ...
		               <?php
										...
										elseif ( is_object_in_term( $post->ID, 'category', 'elections2018' ) ) :
										...
										elseif ( is_object_in_term( $post->ID, 'category', 'elections2019' ) ) :
	              ...
	              <h2 style="text-align: center; text-transform: uppercase; background: white; color: black; font-size: 37px; font-family: 'lft-etica', sans-serif; margin: 0px auto 20px auto; width: 280px; padding: 0px; font-weight: 800; line-height: 100%;"><?php the_title(); ?></h2>

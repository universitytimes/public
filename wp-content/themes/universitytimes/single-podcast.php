<?php
/*
Template Name Posts: Podcast Template
*/
?>
...
<?php get_header(); ?>
			...
			<div id="content">
	            ...
	            <div class="infogrouping">
		            ...
		            <a href="http://universitytimes.ie/podcasts" class="articlesectiontag newstag" style="background-color: #8f0f61;">PODCAST</a>
                  ...
                  <h2 class="articleheadline_dearfresherme" itemprop="headline"><?php the_title(); ?></h2>
                  
                  <h3 class="articlesub"><span class="articlesub_black"><?php 
					  ...
					  elseif ($old_caption !== "" && $old_caption !== false) {	echo get_post_meta($post->ID, '_visual-subtitle', true); 	}	?></span></h3>
       ...
       <div class="utcontentgrouping <?php if ($utpostimage_position == 'landscaperight' && $utpostimage_url != '') { echo "utcontentgroupinglandscape";}
                 ...
                 <div class="writershareblock">
							...
							echo '<span class="onebigauthorname">';
								...
								echo 'Episode edited by <span class="authoruppercase"><a href="'.$getwriterpage1url.'">'.get_post_meta( get_the_ID(), '_writer_name', true ).'</a></span>';
								...
								echo 'Episode edited by <span class="authoruppercase">'.get_post_meta( get_the_ID(), '_writer_name', true ).'</span>';	

<header class="article-header">
       ...
       <div class="utcontentgrouping">
                 ...
                 <div class="writershareblock">
                  ...
                  <div class="overallnotebook">
                  
                  		<div class="editorialnotebookicon">
				  		...
				  		<div class="notebooktext">
				  			...
				  			<span class="onebigauthorname"><span class="editorialnotebookauthor">Editorial Notebook</span>
						
				  			<span class="editorialnotebookauthorsmall">BY <a href="http://www.universitytimes.ie/editorialboard">THE EDITORIAL BOARD</a>
...
jQuery(window).trigger('resize');
                ...
                <section class="utpost-content cf utpost-contenteditorialnote" itemprop="articleBody">

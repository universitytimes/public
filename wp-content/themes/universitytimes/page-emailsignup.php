<?php
/*
 Template Name: Email Newsletter Sign-Up
 *
					...
					<div id="articlecontent">
							...
							<div class="pagegrouping">
								...
								<header class="article-header">
									...
									<div class="emailnewslettersicon">
										...
										<div class="newsletterpageheadertext">
										 ...
										 <div class="getinyourinbox mobilegetinyourinbox" style="margin-bottom: 25px;">Get The University Times into your inbox twice a week.</div>
...
<div class="zeroline" style="margin-top: 25px;">

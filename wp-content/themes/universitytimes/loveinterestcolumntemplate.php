<header class="article-header">
	             ...
	             <?php $columncountnumber = get_post_meta($post->ID, 'columncountnumber', true); ?>  
	              
	            <div class="loveinterestcolumncount">COLUMN  <?php echo $columncountnumber ?> 
	            ...
	            </div> <div class="dateright"><?php the_date('M j, Y'); ?></div>
	            
	            
	            <a href="http://universitytimes.ie/loveinterest" class="loveinterestheading loveinterestslightlysmaller">
                  ...
                  <h2 class="articleheadline_loveinterest articleheadline_loveinterestcolumn" itemprop="headline"><?php the_title(); ?></h2>
...
jQuery(window).trigger('resize');
                ...
                <?php    if ($writername5 == "" and $writername4 == "" and $writername3 == "" and $writername2 == "" and $writername !== "") {   ?>

	                
	                
	               <div class="loveinterest_squarebyline">
		               
		               <div class="bylinetext">
		            BY 
		              
		              
		              <div class="writernameli">

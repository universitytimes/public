<?php
/*
Template Name Posts: Dear Fresher Me New
*/
?>
...
<?php get_header(); ?>
			...
			<div id="content">
	            ...
	            <div class="infogrouping">
                  ...
                  <h3 class="articlesub"><span class="articlesub_black"><strong>FORMER FRESHERS</strong> on their experiences of their very first week of college and the transition to the rest of their lives.</span></h3>

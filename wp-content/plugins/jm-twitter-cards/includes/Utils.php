...
class Utils
{
    ...
    public static function get_excerpt_by_id($post_id)
    {
        ...
        $post_content = post_password_required($the_post) === true || get_post_status($post_id) === 'private' ? '' : $the_post->post_content;
        $the_excerpt = !empty($the_post->post_excerpt) ? $the_post->post_excerpt : $post_content; 

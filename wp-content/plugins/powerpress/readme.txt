...
= 11.17.5 =
* Fix notice output and add dedup to store
...
* Update error handling for the updated media verification response in post editor
* Added in depth publish failure logging
* Extracted publishing logic to its own class and file for testability

= 11.17.1 =
* Additional security improvement recommended by Meher Sudhakar Abbireddi

= 11.17 =
* Updates to support changes to Blubrry's commerce system
* Additional security improvement recommended by Meher Sudhakar Abbireddi

= 11.16.11 =
* Security improvement recommended by Meher Sudhakar Abbireddi

= 11.16.10 =
* Update and Improvement for importer

= 11.16.9 =
* Security improvements

= 11.16.8 =
* Fix blank post editor caused by network assets enqueuing on init
...
* Fix admin dashboard state bug
* Add new tool for resetting oauth connection to Blubrry
* Align styling in post editor

= 11.16.5 =
* Add ID3 CHAP/CTOC embedding to mp3 functionality

= 11.16.4 =
* Fix artwork save bug
* Fix category podcasting bug
...
= 11.16.1 =
* Released on 04/28/26
* Bugfix: Null authentication fix on program info load
* Copy update
...
= 11.15.17 =
* Released on 3/02/26
* Bugfix: Metabox podcast optimziation mobile styling fixes
* Bugfix: Error outputting html
* Bugfix: Stale v4v cleanup on update
...
= 11.15.14 =
* Released on 2/12/26
* Remove deprecated css enqueue
* Security update

= 11.15.13 =
* Released on 2/5/26
* Bugfix: Version update fix

= 11.15.12 =
* Released on 2/4/26
* Bugfix: Simplified cache invalidation logic
...
* Bugfix from prior release: Use WP's built-in functions instad of cURL
...
* Update skipto timestamp check to allow floats
...
* Updated Blubrry V4V fee address

= 11.13.3 =
* Released on 06/25/2025
* Security updates
* Fixed bugs in alternate enclosure and content link inputs

= 11.13.2 =
* Released on 06/17/2025
* Fixed bugs related to location tag update for channel/category users

= 11.13.1 =
* Released on 06/17/2025
* Fixed bugs related to location tag update

= 11.13.0 =
* Released on 06/15/2025
* Updates to the location tag to match current spec
...
* Fixed a bug that was causing issues in the destinations tab for channel feeds
...
* Detect mime type for vtt files

= 11.12.4 =
* Released on 03/31/2025
* Escape trailer and live item titles to prevent XML parse errors in feeds
...
* Add copy below Connect button

= 11.12.1 =
* Released on 02/20/2025
* Fix spacing for subscribe widget
* Add ability to use apple claim token

= 11.12.0 =
* Released on 01/27/2025
* Disable destinations on feeds with 0 episodes

= 11.11.1 =
* Released on 01/20/2025
* Add tabnab protection

= 11.11.0 =
* Released on 01/13/2025
* Added Funding tag to episode level

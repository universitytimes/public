...
if ( !class_exists( 'MeowKit_WR2X_Helpers' ) ) {

  class MeowKit_WR2X_Helpers {
    //public static $version = MeowKit_WR2X_Admin::version;
    ...
    public static function timer_start( $timerName = 'default' ) {
      MeowKit_WR2X_Helpers::$startQueries[ $timerName ] = get_num_queries();
      MeowKit_WR2X_Helpers::$startTimes[ $timerName ] = microtime( true );
    }

    public static function timer_elapsed( $timerName = 'default' ) {
      return microtime( true ) - MeowKit_WR2X_Helpers::$startTimes[ $timerName ];
    }

    public static function timer_log_elapsed( $timerName = 'default' ) {
      $elapsed = MeowKit_WR2X_Helpers::timer_elapsed( $timerName );
      $queries = get_num_queries() - MeowKit_WR2X_Helpers::$startQueries[ $timerName ];

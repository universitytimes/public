...
= 1.3.12 =
* Changed how the end live blog works so that it doesn't attempt to merge updates - merge will made into separate step in future release
...
* Fixed droping of Author names on re-edit if not real users

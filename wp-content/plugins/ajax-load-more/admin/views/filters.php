			...
			<div class="cta">
				...
				<div class="cta-inner">
					...
					<p><strong><?php esc_attr_e( 'Examples:', 'ajax-load-more' ); ?></strong><br/>
						<a href="https://ajaxloadmore.com/add-ons/filters/#examples" target="_blank"><?php esc_attr_e( 'Basic Filtering', 'ajax-load-more' ); ?></a>,
						<a href="https://ajaxloadmore.com/add-ons/filters/facet-filtering/" target="_blank"><?php esc_attr_e( 'Facets', 'ajax-load-more' ); ?></a>,
						<a href="https://ajaxloadmore.com/add-ons/filters/datepicker-range/" target="_blank"><?php esc_attr_e( 'Date Picker', 'ajax-load-more' ); ?></a>,
						<a href="https://ajaxloadmore.com/add-ons/filters/search/?search=Ajax%20Load%20More" target="_blank"><?php esc_attr_e( 'Search', 'ajax-load-more' ); ?></a>,
						<a href="https://ajaxloadmore.com/add-ons/filters/selected-filters/?category=open-source+release-notes" target="_blank"><?php esc_attr_e( 'Selected Filters', 'ajax-load-more' ); ?></a>
					</p>
				</div>
				<div class="major-publishing-actions">
					<a class="button button-primary" target="_blank" href="https://ajaxloadmore.com/add-ons/filters/">

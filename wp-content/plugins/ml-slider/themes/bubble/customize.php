    ...
    array(
        ...
        'settings' => array(
            ...
            array(
                ...
                'max' => 15,
                'css' => array(
                    '[ms_id] .flexslider:not(.filmstrip) ul.flex-direction-nav li a.flex-prev { left: [ms_value]% !important }',
                    '[ms_id] .flexslider:not(.filmstrip) ul.flex-direction-nav li a.flex-next { right: [ms_value]% !important }'
                ),
                'scope' => array(
                    'links' => array( 
                        'true',
            ...
            array(
                ...
                'css' => 'css_rules',
                'css_rules' => array(
                    'top' => '[ms_id] .flexslider:not(.filmstrip) ul.flex-direction-nav li a { bottom: unset; top: [ms_field_value]%; transform: translateY(-[ms_field_value]%); }', // Take [ms_field_value] from arrows_vertical_position_offset
                    'bottom' => '[ms_id] .flexslider:not(.filmstrip) ul.flex-direction-nav li a { top: unset; bottom: [ms_field_value]%; transform: translateY([ms_field_value]%); }' // Take [ms_field_value] from arrows_vertical_position_offset
                ),
                'scope' => array(
                    'links' => array( 
                        'true',
            ...
            array(
                ...
                'type' => 'color',
                'default' => '#fff',
                'css' => '[ms_id] .flexslider ul.flex-direction-nav li a:focus { outline-color: [ms_value] }',
                'scope' => array(
                    'links' => array(
                        'true',
                        'onhover'
            ...
            array(
                ...
                'min' => 0,
                'max' => 10,
                'css' => '[ms_id] .flexslider ul.flex-direction-nav li a:focus { outline-width: [ms_value]px }',
                'scope' => array(
                    'links' => array(
                        'true',
                        'onhover'
            ...
            array(
                ...
                'min' => -10,
                'max' => 20,
                'css' => '[ms_id] .flexslider ul.flex-direction-nav li a:focus { outline-offset: [ms_value]px }',
                'scope' => array(
                    'links' => array(
                        'true',
                        'onhover'
    ...
    array(
        ...
        'settings' => array(
            ...
            array(
                ...
                'css' => '[ms_id] .flexslider ol.flex-control-nav:not(.flex-control-thumbs) li a { border-style: [ms_value] }',
                'scope' => array(
                    'navigation' => array( 
                        'true',
                        'dots_onhover'
            ...
            array(
                ...
                'info' => esc_html__('The color of the pagination numbers.', 'ml-slider'),
                'type' => 'fields',
                'fields' => array(
                    array(
                        'label' => esc_html__('Default', 'ml-slider'),
    ...
    array(
        ...
        'settings' => array(
            ...
            array(
                ...
                'info' => esc_html__("The Line Height uses rem units. The display is relative to your theme's CSS so the preview be different from the frontend display.", 'ml-slider'),

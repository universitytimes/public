    ...
    array(
        ...
        'settings' => array(
            ...
            array(
                ...
                'max' => 15,
                'css' => array(
                    '[ms_id] .flexslider:not(.filmstrip) .flex-direction-nav li a.flex-prev { left: [ms_value]% }',
                    '[ms_id] .flexslider:not(.filmstrip) .flex-direction-nav li a.flex-next { right: [ms_value]% }'
                ),
                'scope' => array(
                    'links' => array( 
                        'true',
    ...
    array(
        ...
        'settings' => array(
            ...
            array(
                ...
                'max' => 6,
                'css' => array(
                    '[ms_id] .flexslider ol.flex-control-nav:not(.flex-control-thumbs) li { border-left-width: [ms_value]px; border-bottom-width: [ms_value]px }',
                    '[ms_id] .flexslider ol.flex-control-nav:not(.flex-control-thumbs) li:last-child { border-right-width: [ms_value]px }'
                ),
                'scope' => array(
                    'navigation' => array( 
                        'true',
            ...
            array(
                ...
                'css' => '[ms_id] .flexslider ol.flex-control-nav:not(.flex-control-thumbs) li { border-style: [ms_value] }',
                'scope' => array(
                    'navigation' => array( 
                        'true',
                        'dots_onhover'
            ...
            array(
                ...
                'info' => esc_html__('The color of the pagination text and numbers.', 'ml-slider'),
                'type' => 'fields',
                'fields' => array(
                    array(
                        'label' => esc_html__('Default', 'ml-slider'),
            ...
            array(
                ...
                'info' => esc_html__('The font size of the pagination numbers.', 'ml-slider'),

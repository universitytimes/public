...
return array(
    array(
        ...
        'settings' => array(
            ...
            array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'type' => 'color',
                        'default' => 'rgba(0,0,0,0)',
                        'css' => '[ms_id] .flexslider .flex-direction-nav li:hover { border-color: [ms_value] }'
                    )
                ),
            ...
            array(
                ...
                'css' => '[ms_id] .flexslider .flex-direction-nav li { border-style: [ms_value] }',
                'scope' => array(
                    'links' => array( 
                        'true',
                        'onhover'
            ...
            array(
                ...
                'type' => 'color',
                'default' => '#0A84FF',
                'css' => '[ms_id] .flexslider .flex-direction-nav li:focus-within { outline-color: [ms_value] }',
                'scope' => array(
                    'links' => array(
                        'true',
                        'onhover'
            ...
            array(
                ...
                'min' => 0,
                'max' => 10,
                'css' => '[ms_id] .flexslider .flex-direction-nav li:focus-within { outline-width: [ms_value]px }',
                'scope' => array(
                    'links' => array(
                        'true',
                        'onhover'
            ...
            array(
                ...
                'min' => -10,
                'max' => 20,
                'css' => '[ms_id] .flexslider .flex-direction-nav li:focus-within { outline-offset: [ms_value]px }',
                'scope' => array(
                    'links' => array(
                        'true',
                        'onhover'
    ...
    array(
        ...
        'settings' => array(
            array(
                'label' => esc_html__('Background', 'ml-slider'),
                'info' => esc_html__('The background color of the button shown on the slide.', 'ml-slider'),
                'type' => 'fields',
                'fields' => array(
                    array(
                        'label' => esc_html__('Default', 'ml-slider'),

    ...
    array(
        ...
        'settings' => array(
            ...
            array(
                ...
                'css' => 'css_rules',
                'css_rules' => array(
                    'top' => '[ms_id] .flexslider:not(.filmstrip) ul.flex-direction-nav li a{ bottom: unset; top: calc([ms_field_value]% + 30px); transform: translateY(-[ms_field_value]%); }', // Take [ms_field_value] from arrows_vertical_position_offset

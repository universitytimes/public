    ...
    array(
        ...
        'settings' => array(
            ...
            array(
                ...
                'max' => 500,
                'css' => array(
                    '[ms_id] .flexslider:not(.filmstrip) .flex-direction-nav { right: [ms_value]px }'
                ),
                'scope' => array(
                    'links' => array( 
                        'true',
            ...
            array(
                ...
                'css' => 'css_rules',
                'css_rules' => array(
                    'top' => '[ms_id] .flexslider:not(.filmstrip) .flex-direction-nav { bottom: unset; top: [ms_field_value]%; transform: translateY(-[ms_field_value]%) }', // Take [ms_field_value] from arrows_vertical_position_offset
                    'bottom' => '[ms_id] .flexslider:not(.filmstrip) .flex-direction-nav { top: unset; bottom: [ms_field_value]%; transform: translateY([ms_field_value]%) }' // Take [ms_field_value] from arrows_vertical_position_offset
                ),
                'scope' => array(
                    'links' => array( 
                        'true',
            ...
            array(
                ...
                'min' => 20,
                'max' => 60,
                'css' => '[ms_id] .flexslider:not(.filmstrip) .flex-direction-nav li a { width: [ms_value]px }',
                'scope' => array(
                    'links' => array( 
                        'true',
                        'onhover'
            ...
            array(
                ...
                'min' => 20,
                'max' => 60,
                'css' => '[ms_id] .flexslider:not(.filmstrip) .flex-direction-nav li a, [ms_id] .flexslider:not(.filmstrip) .flex-direction-nav li { height: [ms_value]px }',
                'scope' => array(
                    'links' => array( 
                        'true',
                        'onhover'
            ...
            array(
                ...
                'min' => 0,
                'max' => 30,
                'css' => '[ms_id] .flexslider:not(.filmstrip) .flex-direction-nav li a { border-radius: [ms_value]px }',
                'scope' => array(
                    'links' => array( 
                        'true',
                        'onhover'
    ...
    array(
        ...
        'settings' => array(
            ...
            array(
                ...
                'css' => 'css_rules',
                'css_rules' => array(
                    'top' => '[ms_id] .flexslider .flex-control-nav { bottom: unset; top: [ms_field_value]%; transform: translateY(-[ms_field_value]%) }', // Take [ms_field_value] from navigation_vertical_position_offset
                    'bottom' => '[ms_id] .flexslider .flex-control-nav { top: unset; bottom: [ms_field_value]%; transform: translateY([ms_field_value]%) }' // Take [ms_field_value] from navigation_vertical_position_offset
                ),
                'scope' => array(
                    'navigation' => array( 
                        'true',
            ...
            array(
                ...
                'min' => 0,
                'max' => 50,
                'css' => '[ms_id] .flexslider .flex-control-nav li a { margin-top: [ms_value]px; margin-bottom: [ms_value]px }',
                'scope' => array(
                    'navigation' => array( 
                        'true',
                        'dots_onhover'
            ...
            array(
                ...
                'fields' => array(
                    array(
                        ...
                        'css' =>  '[ms_id] .flexslider .caption-wrap .caption { background: linear-gradient(to bottom, rgba(0,0,0,0), [ms_value]) }'
                    ),
                    array(

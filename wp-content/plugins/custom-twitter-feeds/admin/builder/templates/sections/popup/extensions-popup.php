<div class="ctf-fb-extensions-pp-ctn sb-fs-boss ctf-fb-center-boss" v-if="viewsActive.extensionsPopupElement != null && viewsActive.extensionsPopupElement != false" role="dialog" aria-modal="true" :aria-label="genericText.dialogExtension">
	<div class="ctf-fb-extensions-popup ctf-fb-popup-inside" v-if="viewsActive.extensionsPopupElement != null && viewsActive.extensionsPopupElement != false" :data-getext-view="viewsActive.extensionsPopupElement">
        ...
        <div class="ctf-fb-popup-cls" role="button" tabindex="0" :aria-label="genericText.close" @click.prevent.default="activateView('extensionsPopupElement')" @keydown.enter.prevent="activateView('extensionsPopupElement')" @keydown.space.prevent="activateView('extensionsPopupElement')">
                ...
                <div v-if="typeof extensionsPopup[viewsActive.extensionsPopupElement].bullets !== 'undefined'" class="ctf-extension-bullets">
                    ...
                    <div class="ctf-extension-bullet-list">
                        <div class="ctf-extension-single-bullet" v-for="bullet in extensionsPopup[viewsActive.extensionsPopupElement].bullets.content">
                            <svg aria-hidden="true" focusable="false" width="4" height="4" viewBox="0 0 4 4" fill="none" xmlns="http://www.w3.org/2000/svg">

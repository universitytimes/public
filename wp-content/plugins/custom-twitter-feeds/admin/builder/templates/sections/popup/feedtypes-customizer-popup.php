<div class="ctf-fb-feedtypescustomizer-pp-ctn sb-fs-boss ctf-fb-center-boss" role="dialog" aria-modal="true" :aria-label="genericText.editSources" @keydown.esc.prevent="cancelFeedTypeAndSourcesCustomizer()" v-if="viewsActive.feedtypesCustomizerPopup">
    <div class="ctf-fb-feedtypes-popup ctf-fb-popup-inside">
        <div class="ctf-fb-popup-cls" role="button" tabindex="0" :aria-label="genericText.close" @click.prevent.default="cancelFeedTypeAndSourcesCustomizer()" @keydown.enter.prevent="cancelFeedTypeAndSourcesCustomizer()" @keydown.space.prevent="cancelFeedTypeAndSourcesCustomizer()"><svg aria-hidden="true" focusable="false" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M14 1.41L12.59 0L7 5.59L1.41 0L0 1.41L5.59 7L0 12.59L1.41 14L7 8.41L12.59 14L14 12.59L8.41 7L14 1.41Z" fill="#141B38"></path></svg></div>
    	...
    	<div class="ctf-fb-feedtypescustomizer-content ctf-fb-fs">
			...
			?>
			<div class="ctf-addsource-type-btn ctf-fb-fs" role="button" tabindex="0" :aria-label="genericText.addSourceType" @click.prevent.default="toggleFeedTypesChooserPopup()" @keydown.enter.prevent="toggleFeedTypesChooserPopup()" @keydown.space.prevent="toggleFeedTypesChooserPopup()">

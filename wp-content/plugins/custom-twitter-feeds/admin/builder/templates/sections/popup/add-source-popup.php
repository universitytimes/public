<script type="text/x-template" id="sb-add-source-component">
    <div class="ctf-fb-source-ctn sb-fs-boss ctf-fb-center-boss" v-if="viewsActive.sourcePopup" role="dialog" aria-modal="true" :aria-label="genericText.dialogAddSource" @keydown.esc="viewsActive.sourcePopupType == 'customizer' ? $parent.closeSourceCustomizer() : $parent.activateView('sourcePopup')">
        ...
        <div class="ctf-fb-source-popup ctf-fb-popup-inside ctf-fb-source-pp-customizer" v-bind:class="{ 'ctf-narrower-modal' : typeof viewsActive.sourcePopupScreen !== 'undefined' && viewsActive.sourcePopupScreen === 'step_4' }" v-if="viewsActive.sourcePopupType == 'customizer'">
            <div class="ctf-fb-popup-cls" role="button" tabindex="0" :aria-label="genericText.close" @click.prevent.default="$parent.closeSourceCustomizer()" @keydown.enter.prevent="$parent.closeSourceCustomizer()" @keydown.space.prevent="$parent.closeSourceCustomizer()">
            ...
            <div class="ctf-fb-source-top ctf-fb-fs">
                ...
                <div class="ctf-fb-srcslist-ctn ctf-fb-fs">
                    <div class="ctf-fb-srcs-item ctf-fb-srcs-new" role="button" tabindex="0" @click.prevent.default="$parent.activateView('sourcePopup', 'creationRedirect')" @keydown.enter.prevent="$parent.activateView('sourcePopup', 'creationRedirect')" @keydown.space.prevent="$parent.activateView('sourcePopup', 'creationRedirect')">
                    ...
                    <div class="ctf-fb-srcs-item" v-for="(source, sourceIndex) in sourcesList" role="checkbox" tabindex="0" :aria-checked="$parent.isSourceActiveCustomizer(source) ? 'true' : 'false'" :aria-label="source.username" @click.prevent.default="$parent.selectSourceCustomizer(source)" @keydown.enter.prevent="$parent.selectSourceCustomizer(source)" @keydown.space.prevent="$parent.selectSourceCustomizer(source)" :data-type="source.account_type"
                    ...
                    >
                        ...
                        <div class="ctf-fb-srcs-item-avatar" v-if="$parent.returnAccountAvatar(source)">
                            <img :src="$parent.returnAccountAvatar(source)" :alt="source.username ? source.username + ' avatar' : ''">
                        </div>
                        <div class="ctf-fb-srcs-item-inf">
                            ...
                            <div class="ctf-fb-left-boss">
                                ...
                                <div v-if="source.error !== ''" class="sb-source-error-wrap">
                                    <span v-html="genericText.invalid"></span><button type="button" @click.prevent.default="$parent.activateView('sourcePopupType', 'creation')" v-html="genericText.reconnect"></button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="ctf-fb-source-popup ctf-fb-popup-inside" v-bind:class="{ 'ctf-narrower-modal' : typeof viewsActive.sourcePopupScreen !== 'undefined' && viewsActive.sourcePopupScreen === 'step_4' }" v-if="viewsActive.sourcePopupType != 'customizer'" :data-step="viewsActive.sourcePopupScreen">
            <div class="ctf-fb-popup-cls" role="button" tabindex="0" :aria-label="genericText.close" @click.prevent.default="$parent.activateView('sourcePopup')" @keydown.enter.prevent="$parent.activateView('sourcePopup')" @keydown.space.prevent="$parent.activateView('sourcePopup')" v-if="viewsActive.sourcePopupScreen != 'redirect_1'">
                <svg aria-hidden="true" focusable="false" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M14 1.41L12.59 0L7 5.59L1.41 0L0 1.41L5.59 7L0 12.59L1.41 14L7 8.41L12.59 14L14 12.59L8.41 7L14 1.41Z" fill="#141B38"/>
                </svg>
            </div>
            ...
            <div class="ctf-fb-source-step1 ctf-fb-fs" v-if="viewsActive.sourcePopupScreen == 'step_1'" v-bind:class="{ 'ctf-has-alert' : typeof window.ctfSelectedFeed !== 'undefined' && window.ctfSelectedFeed !== 'user'}">
                <div class="ctf-fb-source-top ctf-fb-fs">
                    <div class="ctf-fb-fs" v-if="viewsActive.sourcePopupType === 'customizer'">
                        <div class="ctf-fb-src-back-top" role="button" tabindex="0" @click.prevent.default="$parent.activateView('sourcePopup', 'updateCustomizer')" @keydown.enter.prevent="$parent.activateView('sourcePopup', 'updateCustomizer')" @keydown.space.prevent="$parent.activateView('sourcePopup', 'updateCustomizer')">
                            <svg aria-hidden="true" focusable="false" width="6" height="9" viewBox="0 0 6 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="ctf-fb-stp1-elm ctf-fb-fs">
                        ...
                        <div class="ctf-fb-stp1-elm-act ctf-fb-stp-src-ctn">
                            <div class="ctf-fb-stp-src-type sb-small-p sb-dark-text" role="button" tabindex="0" :aria-pressed="(typeof window.ctfSelectedFeed === 'undefined' || window.ctfSelectedFeed[0] === 'user') && addNewSource.typeSelected !== 'business' ? 'true' : 'false'" :data-disabled="(typeof window.ctfSelectedFeed !== 'undefined' && window.ctfSelectedFeed[0] !== 'user')" :data-active="(typeof window.ctfSelectedFeed === 'undefined' || window.ctfSelectedFeed[0] === 'user') && addNewSource.typeSelected !== 'business'" @click.prevent.default="typeof window.ctfSelectedFeed === 'undefined' || window.ctfSelectedFeed[0] === 'user' ? addNewSource.typeSelected = 'personal' : addNewSource.typeSelected = 'business'" @keydown.enter.prevent="typeof window.ctfSelectedFeed === 'undefined' || window.ctfSelectedFeed[0] === 'user' ? addNewSource.typeSelected = 'personal' : addNewSource.typeSelected = 'business'" @keydown.space.prevent="typeof window.ctfSelectedFeed === 'undefined' || window.ctfSelectedFeed[0] === 'user' ? addNewSource.typeSelected = 'personal' : addNewSource.typeSelected = 'business'">
                                <div class="ctf-fb-chbx-round"></div>{{selectSourceScreen.personal}}
                            </div>
                            <div class="ctf-fb-stp-src-type sb-small-p sb-dark-text" role="button" tabindex="0" :aria-pressed="addNewSource.typeSelected == 'business' ? 'true' : 'false'" :data-active="addNewSource.typeSelected == 'business'" @click.prevent.default="addNewSource.typeSelected = 'business'" @keydown.enter.prevent="addNewSource.typeSelected = 'business'" @keydown.space.prevent="addNewSource.typeSelected = 'business'">
                            ...
                            <div class="ctf-fb-stp-src-type ctf-not-sure-wrap sb-small-p sb-dark-text">
                                ...
                                <div class="ctf-fb-onbrd-tltp-elem ctf-not-sure-tooltip sb-tr-2">
                                    ...
                                    <div class="sb-pointer sb-bottom-pointer">
                                        <svg aria-hidden="true" focusable="false" width="20" height="10" viewBox="0 0 20 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="ctf-fb-source-bottom ctf-fb-fs">
                    <div class="ctf-manual-question">
                        <svg aria-hidden="true" focusable="false" width="20" height="15" viewBox="0 0 20 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button class="ctf-fb-hd-btn ctf-fb-src-add-manual sb-btn-grey" @click.prevent.default="$parent.switchScreen('sourcePopupScreen','step_3')">
                        <svg aria-hidden="true" focusable="false" width="12" height="13" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="ctf-fb-source-step2 ctf-fb-fs" v-if="viewsActive.sourcePopupScreen == 'step_2'">
                <div class="ctf-fb-source-top ctf-fb-fs">
                    <div class=" ctf-fb-fs">
                        <div class="ctf-fb-src-back-top" role="button" tabindex="0" @click.prevent.default="$parent.switchScreen('sourcePopupScreen','step_1')" @keydown.enter.prevent="$parent.switchScreen('sourcePopupScreen','step_1')" @keydown.space.prevent="$parent.switchScreen('sourcePopupScreen','step_1')">
                            <svg aria-hidden="true" focusable="false" width="6" height="9" viewBox="0 0 6 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M5.27398 1.44L4.33398 0.5L0.333984 4.5L4.33398 8.5L5.27398 7.56L2.22065 4.5L5.27398 1.44Z" fill="#434960"/>
                            </svg>
                    ...
                    <div v-if="typeof $parent.newSourceData === 'undefined' || typeof $parent.newSourceData.error === 'undefined'" >
                        ...
                        <div class="ctf-fb-source-account-info ctf-fb-fs">
                            ...
                            <img :src="$parent.hasOwnNestedProperty(newSourceData,'user.picture.data.url') ? newSourceData.user.picture.data.url : ''" :alt="$parent.hasOwnNestedProperty(newSourceData,'user.name') ? newSourceData.user.name + ' avatar' : ''"> <strong v-if="$parent.hasOwnNestedProperty(newSourceData,'user.name')" v-html="newSourceData.user.name"></strong>
                        ...
                        <div class="ctf-fb-source-list ctf-fb-fs">
                            <div class="ctf-fb-srcs-item" v-for="(source, sourceIndex) in returnedApiSourcesList" role="checkbox" tabindex="0" :aria-checked="selectedSourcesToConnect.includes(source.account_id) ? 'true' : 'false'" :aria-label="source.username" @click.prevent.default="selectSourcesToConnect(source)" @keydown.enter.prevent="selectSourcesToConnect(source)" @keydown.space.prevent="selectSourcesToConnect(source)" :data-active="selectedSourcesToConnect.includes(source.account_id)" >
                                <div class="ctf-fb-srcs-item-chkbx">
                                    <div class="ctf-fb-srcs-item-chkbx-ic"></div>
                                </div>
                                <div class="ctf-fb-srcs-item-avatar" v-if="returnAccountAvatar(source)">
                                    <img :src="returnAccountAvatar(source)" :alt="source.username ? source.username + ' avatar' : ''">
                                </div>
                                <div class="ctf-fb-srcs-item-inf">
                        ...
                        <div class="ctf-businesses-connect-actions" v-if="addNewSource.typeSelected === 'business'">
                            ...
                            <button class="ctf-fb-source-btn ctf-fb-source-btn-next ctf-fb-fs sb-btn-blue"  @click.prevent.default="$parent.switchScreen('sourcePopupScreen','step_4')" :data-active="typeof window.ctfSelected !== 'undefined' && window.ctfSelected.length ? 'true' : 'false'">
                                ...
                                <svg aria-hidden="true" focusable="false" width="7" height="11" viewBox="0 0 7 11" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.3332 0.00683594L0.158203 1.18184L3.97487 5.00684L0.158203 8.83184L1.3332 10.0068L6.3332 5.00684L1.3332 0.00683594Z" fill="white"></path></svg>
                            </button>
                        </div>
                    </div>
                ...
                <div class="ctf-fb-source-top ctf-fb-fs">
                    ...
                    <div class="ctf-fb-fs">
                        ...
                        <div class="ctf-fb-source-mnl-type ctf-fb-fs">
                            <div class="ctf-fb-stp1-elm-act ctf-fb-stp-src-ctn">
                                <div class="ctf-fb-stp-src-type" role="button" tabindex="0" :aria-pressed="addNewSource.typeSelected == 'personal' ? 'true' : 'false'" :data-active="addNewSource.typeSelected == 'personal'" @click.prevent.default="addNewSource.typeSelected = 'personal'" @keydown.enter.prevent="addNewSource.typeSelected = 'personal'" @keydown.space.prevent="addNewSource.typeSelected = 'personal'">
                                    <div class="ctf-fb-chbx-round"></div><span class="sb-small-p sb-dark-text">{{selectSourceScreen.personal}}</span>
                                </div>
                                <div class="ctf-fb-stp-src-type" role="button" tabindex="0" :aria-pressed="addNewSource.typeSelected == 'business' ? 'true' : 'false'" :data-active="addNewSource.typeSelected == 'business'" @click.prevent.default="addNewSource.typeSelected = 'business'" @keydown.enter.prevent="addNewSource.typeSelected = 'business'" @keydown.space.prevent="addNewSource.typeSelected = 'business'">
            ...
            <div class="ctf-fb-source-step4 ctf-fb-fs" v-if="viewsActive.sourcePopupScreen == 'step_4'">
                <div class="ctf-source-account-box ctf-fb-fs">
                    <div class="ctf-connecting-account-item" v-for="(source, sourceIndex) in returnedApiSourcesList" role="checkbox" tabindex="0" :aria-checked="selectedSourcesToConnect.includes(source.account_id) ? 'true' : 'false'" :aria-label="source.username" @click.prevent.default="selectSourcesToConnect(source)" @keydown.enter.prevent="selectSourcesToConnect(source)" @keydown.space.prevent="selectSourcesToConnect(source)" :data-active="selectedSourcesToConnect.includes(source.account_id)" >
                        <div class="ctf-fb-srcs-item-avatar" v-if="$parent.returnAccountAvatar(source)">
                            <img :src="$parent.returnAccountAvatar(source)" :alt="source.username ? source.username + ' avatar' : ''">
                        </div>

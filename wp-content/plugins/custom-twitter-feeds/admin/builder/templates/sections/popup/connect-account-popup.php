<div class="ctf-fb-connectaccount-pp-ctn sb-fs-boss ctf-fb-center-boss" v-if="viewsActive.connectAccountPopup" role="dialog" aria-modal="true" :aria-label="genericText.dialogConnectAccount">
	<div class="ctf-fb-connectaccount-popup ctf-fb-popup-inside" data-step="1" v-if="viewsActive.connectAccountStep == 'step_1'">

		<div class="ctf-fb-popup-cls" role="button" tabindex="0" :aria-label="genericText.close" @click.prevent.default="activateView('connectAccountPopup')" @keydown.enter.prevent="activateView('connectAccountPopup')" @keydown.space.prevent="activateView('connectAccountPopup')">
	...
	<div class="ctf-fb-connectaccount-popup ctf-fb-popup-inside" data-step="2" v-if="viewsActive.connectAccountStep == 'step_2'">
		<div class="ctf-fb-popup-cls" role="button" tabindex="0" :aria-label="genericText.close" @click.prevent.default="closeConnectAccountPopup()" @keydown.enter.prevent="closeConnectAccountPopup()" @keydown.space.prevent="closeConnectAccountPopup()">
			<svg aria-hidden="true" focusable="false" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
				<path d="M14 1.41L12.59 0L7 5.59L1.41 0L0 1.41L5.59 7L0 12.59L1.41 14L7 8.41L12.59 14L14 12.59L8.41 7L14 1.41Z" fill="#141B38"/>
			</svg>
		</div>

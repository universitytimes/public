...
<div v-for="tooltip in allFeedsScreen.onboarding.tooltips"
     ...
     role="dialog" aria-modal="true" :aria-label="genericText.dialogOnboarding" v-bind:aria-labelledby="'sb-onboarding-tooltip-' + allFeedsScreen.onboarding.type + '-' + tooltip.step + '-heading'" @keydown.esc.prevent="onboardingClose()">
    ...
    <div class="sb-onboarding-top-row">
        <h2 tabindex="-1" v-bind:id="'sb-onboarding-tooltip-' + allFeedsScreen.onboarding.type + '-' + tooltip.step + '-heading'" class="sb-standard-p sb-bold sb-onboarding-wizard-step-heading">{{tooltip.heading}}</h2>

<div class="ctf-fb-types-ctn ctf-fb-templates-ctn ctf-fb-fs sb-box-shadow" v-if="viewsActive.selectedFeedSection == 'selectTemplate'">
	<div class="ctf-fb-types ctf-fb-fs">
		...
		<div class="ctf-fb-templates-list">
			<div class="ctf-fb-type-el" v-for="(feedTemplateEl, feedTemplateIn) in feedTemplates" role="button" tabindex="0" :aria-label="feedTemplateEl.title" :aria-pressed="selectedFeedTemplate === feedTemplateEl.type ? 'true' : 'false'" :data-active="selectedFeedTemplate === feedTemplateEl.type" @click.prevent.default="chooseFeedTemplate(feedTemplateEl)" @keydown.enter.prevent="chooseFeedTemplate(feedTemplateEl)" @keydown.space.prevent="chooseFeedTemplate(feedTemplateEl)">

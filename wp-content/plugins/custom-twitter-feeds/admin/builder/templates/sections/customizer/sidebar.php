...
<div class="sb-customizer-sidebar" v-bind:class="{ 'sb-onboarding-highlight' : viewsActive.onboardingStep === 2 || viewsActive.onboardingStep === 3 }">
	<div class="sb-customizer-sidebar-sec1 ctf-fb-fs">
		<div class="sb-customizer-sidebar-tab-ctn ctf-fb-fs" v-if="customizerScreens.activeSection == null">
            <div class="sb-customizer-sidebar-tab" role="button" tabindex="0" v-for="tab in customizerSidebarBuilder" :data-active="customizerScreens.activeTab == tab.id" @click.prevent.default="switchCustomizerTab(tab.id)" @keydown.enter.prevent="switchCustomizerTab(tab.id)" @keydown.space.prevent="switchCustomizerTab(tab.id)"><span class="sb-standard-p sb-bold">{{tab.heading}}</span></div>
		</div>
		...
		<div class="sb-customizer-sidebar-sec-ctn ctf-fb-fs" v-if="customizerScreens.activeSection == null">
			<div v-for="(section, sectionId) in customizerSidebarBuilder[customizerScreens.activeTab].sections">
				<div class="sb-customizer-sidebar-sec-el ctf-fb-fs" role="button" tabindex="0" v-if="!section.isHeader" @click.prevent.default="switchCustomizerSection(sectionId, section)" @keydown.enter.prevent="switchCustomizerSection(sectionId, section)" @keydown.space.prevent="switchCustomizerSection(sectionId, section)">
                    ...
                    <div class="sb-customizer-chevron">
                        <svg aria-hidden="true" focusable="false" width="6" height="8" viewBox="0 0 6 8" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<div class="ctf-fb-fs" v-if="customizerScreens.activeSection != null">
			<div class="sb-customizer-sidebar-header ctf-fb-fs" :data-separator="customizerScreens.activeSectionData.separator ? customizerScreens.activeSectionData.separator : ''">
				<div class="sb-customizer-sidebar-breadcrumb ctf-fb-fs">
                    <a role="button" tabindex="0" @click.prevent.default="switchCustomizerTab(customizerScreens.activeTab)" @keydown.enter.prevent="switchCustomizerTab(customizerScreens.activeTab)" @keydown.space.prevent="switchCustomizerTab(customizerScreens.activeTab)">
                        <svg aria-hidden="true" focusable="false" width="6" height="8" viewBox="0 0 6 8" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<a v-if="customizerScreens.parentActiveSection != null" role="button" tabindex="0" @click.prevent.default="switchCustomizerSection(customizerScreens.parentActiveSection, customizerScreens.parentActiveSectionData)" @keydown.enter.prevent="switchCustomizerSection(customizerScreens.parentActiveSection, customizerScreens.parentActiveSectionData)" @keydown.space.prevent="switchCustomizerSection(customizerScreens.parentActiveSection, customizerScreens.parentActiveSectionData)" class="ctf-child-breadcrumb">
                        <svg aria-hidden="true" focusable="false" width="6" height="8" viewBox="0 0 6 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M5.27203 0.94L4.33203 0L0.332031 4L4.33203 8L5.27203 7.06L2.2187 4L5.27203 0.94Z" fill="#434960"/>
                        </svg>{{customizerScreens.parentActiveSectionData.heading}}
                    </a>
                    <a v-if="customizerScreens.parentActiveSection == 'customize_posts' && nestedStylingSection.includes(customizerScreens.activeSection)" role="button" tabindex="0" @click.prevent.default="backToPostElements()" @keydown.enter.prevent="backToPostElements()" @keydown.space.prevent="backToPostElements()" class="ctf-child-breadcrumb">
                        <svg aria-hidden="true" focusable="false" width="6" height="8" viewBox="0 0 6 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M5.27203 0.94L4.33203 0L0.332031 4L4.33203 8L5.27203 7.06L2.2187 4L5.27203 0.94Z" fill="#434960"/>
                        </svg>Elements
                    </a>
				...
				<span class="sb-customizer-sidebar-intro">
					<span v-html="customizerScreens.activeSectionData.description "></span> <a href="#" v-if="customizerScreens.activeSectionData.checkExtensionPopup != undefined" @click.prevent.default="viewsActive.extensionsPopupElement = customizerScreens.activeSectionData.checkExtensionPopup">{{genericText.learnMore}}</a>
				</span>
			</div>
			<div class="sb-customizer-sidebar-controls-ctn ctf-fb-fs">
				...
				<div class="sb-customizer-sidebar-sec-el ctf-fb-fs" role="button" tabindex="0" v-if="customizerScreens.activeSectionData.nested_sections && ((nesetdSection.condition != undefined ? checkControlCondition(nesetdSection.condition) : false) || (nesetdSection.condition == undefined ))" v-for="(nesetdSection, nesetdSectionId) in customizerScreens.activeSectionData.nested_sections" @click.prevent.default="switchCustomizerSection(nesetdSectionId, nesetdSection, true)" @keydown.enter.prevent="switchCustomizerSection(nesetdSectionId, nesetdSection, true)" @keydown.space.prevent="switchCustomizerSection(nesetdSectionId, nesetdSection, true)">

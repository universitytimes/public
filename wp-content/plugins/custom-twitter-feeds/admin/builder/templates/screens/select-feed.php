<div v-if="viewsActive.pageScreen == 'selectFeed'" class="ctf-fb-fs">
	...
	<div class="ctf-fb-ft-action ctf-fb-slctfd-action ctf-fb-fs">
		<div class="ctf-fb-wrapper">
			<div class="ctf-fb-slctf-back ctf-fb-hd-btn ctf-btn-grey" @click.prevent.default="creationProcessBack()"><svg aria-hidden="true" focusable="false" width="7" height="11" viewBox="0 0 7 11" fill="none" xmlns="http://www.w3.org/2000/svg">

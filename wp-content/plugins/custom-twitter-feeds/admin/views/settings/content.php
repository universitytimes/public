<div class="ctf-fb-full-wrapper ctf-fb-fs">
    ...
    <div class="sb-tabs-container" id="sb-tabs-container">
        <form action="">
            <div class="sb-tabs">
                <div class="left-buttons" role="tablist" aria-label="<?php esc_attr_e( 'Settings', 'custom-twitter-feeds' ); ?>">
            ...
            <div  class="ctf-settings-cta">
                <?php
                    TwitterFeed\Admin\CTF_View::render( 'sections.settings_footer_cta' );
                ?>
            </div>
        </form>
    </div>
